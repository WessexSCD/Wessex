...
//---------------------------------------------------------------------------------------------
    ...
    htmlHeader("Spiffin SCDs: About SCD"); //Don't forget to personalise this page title
...
<h3>Scottish Country Dancing</h3>

<p class="indent">Scottish Country Dancing is the traditional ballroom dancing of Scotland. The Royal Scottish Country Dance Society, based in Edinburgh, was founded in 1923 to preserve this joyful social dance tradition. Since then Scottish Country Dancing has spread all over the world.</p>

<p class="indent">Scottish Country dances are danced with partners in sets of two or more couples doing an exciting variety of formations. The dances vary in tempo, including lively jigs, hornpipes and reels, and the slower, elegant strathspeys.</p>

<p class="indent">If you want to join in an activity that is both friendly and fun, why not try Scottish Country Dancing? Anyone of any age can have a go and it gives you the opportunity to enjoy a hobby that's a guaranteed way of forgetting your worries, meeting friends and having fun as well as an energetic way of keeping fit.</p>
