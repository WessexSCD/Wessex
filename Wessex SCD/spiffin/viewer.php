...
//
	...
	require("../includes/template.inc");
        ...
        $handlePicDir=opendir("gallery/".$picdir);
        ...
        $fullname = "gallery/".$picdir."/".$picDescFile;
...
//---------------------------------------------------------------------------------------------
	...
	htmlHeader("Uppingham SCD: picture viewer"); //Don't forget to personalise this page title
  ...
  <tbody>
    <tr>
      ...
      <?php 
        if($thispic>0)
        {
          $backurl = "viewer.php?picdir=".$picdir."&amp;picname=".$piclist[$thispic-1];
      ...
      <?php 
        ...
        {
          $nexturl = "viewer.php?picdir=".$picdir."&amp;picname=".$piclist[$thispic+1];
...
<p>&nbsp;</p>
  <p class="centre">
<?php echo("<img class=\"centre\" src=\"gallery/".$picdir."/".$picname."\" alt=\"".$picname."\" />"); ?>
<p class="centre"><?php echo($picdesc); ?></p>
<h4 class="centre"><a href="gallery.php">Back to Gallery</a></h4>
  </p>
</div>
