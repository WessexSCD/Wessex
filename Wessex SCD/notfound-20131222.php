 ...
 */
  ...
  /* Now let's chek that the page we're going to suggest actually exists */
...
";
  ...
  /* If the referer doesn't exist, it's a person or a bot working from an old, cached link */
  if (!file_exists(substr($requester, 1)))
  {
