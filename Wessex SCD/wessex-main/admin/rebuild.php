<?php
/**
 * rebuild.php allows us to upload CSVs to rebuild our Wessex SCD database.
 *
...
?>
       ...
       <p>This page uploads the CSV file-dumps back into the Wessex SCD database.</p>
